...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Ab\'Dendriel}, {Edron}, {Venore}, {Darashia} or {Nowa}?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To {Ab\'Dendriel}, {Edron}, {Venore}, {Darashia} or {Nowa}?'})
