...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = "Where do you want to go - {Venore}, {Port Hope}, {Liberty Bay}, {Ankrahmun}, {Yalahar}, {Gray Island} or {Nowa}?"})
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = 'I am the captain of this ship.'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = "Where do you want to go - {Venore}, {Port Hope}, {Liberty Bay}, {Ankrahmun}, {Yalahar}, {Gray Island} or {Nowa}?"})
