local config = {
	...
	[4228] = {level = 25, destination = Position(32228, 32596, 8)},
	[4229] = {destination = Position(32237, 32605, 8)},
	[4230] = {level = 25, destination = Position(32243, 32619, 9)},
	[4231] = {destination = Position(32237, 32605, 9)},
	[4232] = {level = 25, destination = Position(32240, 32620, 10)},
	[4233] = {destination = Position(32237, 32605, 10)},
	[4234] = {level = 50, destination = Position(32227, 32598, 11)},
	[4235] = {destination = Position(32237, 32605, 11)},
	[4236] = {level = 50, destination = Position(32238, 32622, 12)},
